...
<style>
	@import 'iconfont/iconfont.css';.select-tab {border-bottom: #F7F7F7 1px solid;background-color: #FFFFFF;display: flex;width: 100%;}

	.select-tab-fixed-top {border-bottom: #F7F7F7 1px solid;background-color: #FFFFFF;display: flex;width: 100%;position: fixed;
		/* #ifdef H5 */
		top: 44px;
		/* #endif */
		/* #ifndef H5 */
	...
	.select-tab-item,
	.select-tab-fixed-top {align-items: center;width: 25%;line-height: 100rpx;text-overflow: ellipsis;overflow: hidden;white-space: nowrap;}

	.select-tab-item text {color: #666666;font-size: 14px;}

	.select-tab-item {width: 187.5rpx;}
</style>
