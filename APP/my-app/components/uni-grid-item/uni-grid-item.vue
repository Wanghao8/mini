...
.uni-grid-item {
	...
	&__box {
		...
		// &.border:after{
		// 	position: absolute;content: '';-webkit-transform-origin: 0 0;transform-origin: 0 0;-webkit-transform: scaleX(0.5);transform: scaleX(0.5);right: 0;bottom: -223rpx;width: 100%;border-right: 1px solid #d0dee5;border-radius: 0;-webkit-transform: scaleY(0.5);transform: scaleY(0.5);height: 200%;border-bottom: 1px solid #d0dee5;
		// }
		&.border-top {
