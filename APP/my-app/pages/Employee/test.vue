	...
	<div class="container">
		<form @submit="formSubmit">
			...
			<div class="nameSex flexrsc">
				<view class="flexccs shortLeft">
					...
					<input :class="showPhoneNum == false ? 'inputBegin fz16' : 'fz16 shortInput'" type="text" v-model="formData.phoneNum"
					 placeholder="手机号码" :placeholder-class="showPhoneNum == false ? 'sleep' : 'noDisplay'" @tap="changePhoneNum" @blur="resetPhoneNumber" />
				</view>
				<view class="flexccs shortLeft">
			...
			<div class="introBox flexccs">
				...
				<textarea :class="showIntro == false ? 'textBegin fz15' : 'fz15 textEnd'" v-model="formData.intro"
				placeholder="简要介绍" :placeholder-style="showIntro == false ? 'font-size:40rpx' : 'display:none'" @tap="changeIntro" @blur="resetIntro" />
			</div>
			<!-- 底部确认&取消按钮 -->
			<div class="footer">
...
<style>
	...
	.introBox {height: 360rpx;}

	.textBegin {height: 360rpx;margin-left: 30rpx;margin-top: 20rpx;}

	.textEnd {height: 360rpx;margin-left: 30rpx;margin-top: 20rpx;}
